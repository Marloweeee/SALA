...
def get_args_parser():
    ...
    parser.add_argument('--linguistic_teacher_model', default='checkpoints/all-mpnet-base-v2', type=str)
...
def build_teacher_model(args):
    ...
    # linguistic teacher model
    from sentence_transformers import SentenceTransformer
    txt_enc_assistant = SentenceTransformer(args.linguistic_teacher_model)
    for param in txt_enc_assistant.parameters():
        param.requires_grad = False

    return  txt_enc_assistant
...
def main(args):
    ...
    # build teacher model
    txt_enc_assistant = build_teacher_model(args)
    txt_enc_assistant.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            args, model, txt_enc_assistant, data_loader_train, optimizer, device, epoch,scaler, args.clip_max_norm,
        )
